 ...
 */
@FeignClient(value = "MICROSERVICE-LOVERENT-UPLOAD-V1",configuration=FeignFullConfig.class,fallback=IUploadAliServiceFall.class)
...
@Component
class IUploadAliServiceFall implements IUploadAliService {
	@Override
