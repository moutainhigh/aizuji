...
var orderAudit = {
	...
	initOpeartBtn:function(){
		var _rentRecord = orderAudit.orderInfo.rentRecord;
		if(!(_rentRecord.state==1 && _rentRecord.creditState==2)) //完成支付 取消订单
		{
			$("#addPhoneAuditRecord").hide();
			$("#passBtn").hide();
			$("#refuseBtn").hide();
		}
	},
