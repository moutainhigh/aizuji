 ...
 * @date 2017-07-12
 */
public class LoanRecordQueryReq extends BaseReq implements Serializable {
	...
	public List<Long> getHistoryIdlist() {
		return historyIdlist;
	}

	public void setHistoryIdlist(List<Long> historyIdlist) {
