package org.gz.user.service.outside;

import org.gz.common.entity.UploadBody;
import org.gz.common.resp.ResponseResult;
import org.gz.user.service.conf.FeignFullConfig;
 ...
 */
@FeignClient(value = "MICROSERVICE-LOVERENT-UPLOAD-V1",configuration=FeignFullConfig.class,fallback=IUploadAliServiceFallBack.class)
