 ...
 *
 */
public class MaterielBasicInfoVO extends BaseEntity {
	...
	protected BigDecimal materielCostPrice;//物料成本
	
	protected Integer materielNewConfigId;//新旧程序配置ID
	
	protected String materielNewConfigValue;//新旧程序配置值
	...
	public String getMaterielNewConfigValue() {
		return materielNewConfigValue;
	}

	public void setMaterielNewConfigValue(String materielNewConfigValue) {
		this.materielNewConfigValue = materielNewConfigValue;
	}
}
