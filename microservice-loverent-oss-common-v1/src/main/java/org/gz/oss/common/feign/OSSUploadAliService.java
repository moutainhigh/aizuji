 ...
 */
@FeignClient(value = "MICROSERVICE-LOVERENT-UPLOAD-V1",configuration=FeignFullConfig.class,fallback=OSSUploadAliServiceFallBack.class)
public interface OSSUploadAliService {
...
@Component
class OSSUploadAliServiceFallBack implements OSSUploadAliService {
	@Override
